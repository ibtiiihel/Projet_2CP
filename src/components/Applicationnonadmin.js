...
function nbrports(valor)
{
    ...
    <div className={toggletabs===2? 'contenu activecontenu' : 'contenu'} id="contenu2" >
        ...
        <h1>Liste des vlans</h1>
           <table >
              <thead >
                 <tr>
                    <th  style={{ textAlign: "center" }}>Nom Vlan   </th>
                    <th  style={{ textAlign: "center" }}>nbr_ports   </th>
             ...
             <tbody>
              { vlanswitch.map((val)=>{
                return<tr>
                   <td  style={{ textAlign: "center" }}>{val.VLAN}</td>
                   <td  style={{ textAlign: "center" }}>{val.nbr}</td>
      ...
      <table>
       <thead>
         <tr>
           ...
           <th  style={{ textAlign: "center" }}>Vlan </th>
           <th  style={{ textAlign: "center" }}> Prise </th>
           <th  style={{ textAlign: "center" }}> Local_prise </th>
           <th  style={{ textAlign: "center" }}> CascadeVers </th>
           <th  style={{ textAlign: "center" }}> port_cascade </th>
           <th  style={{ textAlign: "center" }}> CascadeDe </th>
       ...
       <tbody>
         { listeport.map((val)=>{
           return<tr>
            <td  style={{ textAlign: "center" }}>{val.N_port}</td>
            <td  style={{ textAlign: "center" }}>{val.Type_Port}</td>
            <td  style={{ textAlign: "center" }}>{val.Etat_Port}</td>
            <td  style={{ textAlign: "center" }}>{val.VLAN}</td>
            <td  style={{ textAlign: "center" }}>{val.Prise}</td>
            <td  style={{ textAlign: "center" }}>{val.bloc} / {val.etage} / {val.salle}</td>
            <td  style={{ textAlign: "center" }}>{val.CascadeVers}</td>
            <td  style={{ textAlign: "center" }}>{val.port_cascade}</td>
            <td  style={{ textAlign: "center" }}>{val.CascadeDe}</td>
  ...
  <select id="salle2" onChange={(event)=>{setsalleprise(event.target.value)}} >
   ...
   <div  className='modifie'>
     ...
     <input id="nombloc" type ="text" placeholder='   nom_du_bloc' onChange={(event)=>{setblocname(event.target.value)}}/>
     <label id="texte">Le nbr des etages</label>
     
     <input type ="number" id="nombloc" placeholder='nbr_etages'   onChange={(event)=>{setfloar(event.target.value)}}/>
   ...
   <FontAwesomeIcon id ="close" onClick={changerstatetwo} icon={faClose}></FontAwesomeIcon>
     ...
     <input id="nombloc"type ="text" placeholder='   nom_de_la_salle' onChange={(event)=>{setnsalle(event.target.value)}}/>
...
export default Applicationnonadmin;